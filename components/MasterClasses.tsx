...
const masterClassesData: MasterClassEvent[] = [
  { id: 'mc1', title: 'Основы студийной съемки', date: '2024-07-15', time: '18:00', description: 'Изучите работу со светом, композицию и взаимодействие с моделью.', price: 3000, image: '/images/masterclasses/mc_studio_card.webp', location: 'Лофт Студия "Атмосфера"'},
  { id: 'mc2', title: 'Флористика для начинающих', date: '2024-07-22', time: '17:00', description: 'Создайте свой первый букет под руководством опытного флориста.', price: 2500, image: '/images/masterclasses/mc_floristry_card.webp', location: 'Арт-пространство "Цветочный Рай"'},
  { id: 'mc3', title: 'Секреты создания фотокниг', date: '2024-08-05', time: '19:00', description: 'Научитесь верстать красивые и запоминающиеся фотокниги.', price: 2000, image: '/images/masterclasses/mc_photobook_card.webp', location: 'Конференц-зал "Идея"'},
];

const hallRentalData: HallRentalInfo[] = [
    { id: 'h1', name: 'Зал "Вдохновение"', capacity: 50, pricePerHour: 2000, amenities: ['Проектор', 'Маркерная доска', 'Wi-Fi', 'Кофе-зона'], imageUrls: ['/images/masterclasses/hall1_hero.webp'], description: "Просторный и светлый зал, идеально подходит для лекций, семинаров и тренингов."},
    { id: 'h2', name: 'Аудитория "Прогресс"', capacity: 20, pricePerHour: 1200, amenities: ['Плазменная панель 55"', 'Wi-Fi', 'Кондиционер'], imageUrls: ['/images/masterclasses/hall2_hero.webp'], description: "Уютная аудитория для небольших групп, мастер-классов и совещаний."},
];
