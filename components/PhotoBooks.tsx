...
const formatsData: PhotoBookFormat[] = [
  { 
    ...
    imageUrl: '/images/photobook/Classic 20x20.webp',
  ...
  { 
    ...
    imageUrl: '/images/photobook/Premium 30x30.webp',
  ...
  { 
    ...
    imageUrl: '/images/photobook/Lite 15x20.webp',
   ...
   { 
    ...
    imageUrl: '/images/photobook/Instabook 15x15.webp',
