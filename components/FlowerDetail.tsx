...
import { flowerProductsData } from '../components/Flowers';
...
const FlowerDetail: React.FC = () => {
  ...
  useEffect(() => {
    // Использую общий массив товаров
    const foundProduct = flowerProductsData.find((p: FlowerProduct) => p.id === productId);
