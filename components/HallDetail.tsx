...
const FAKE_HALL_DATA_SOURCE: HallRentalInfo[] = [
    { 
        ...
        imageUrls: [
            '/images/masterclasses/hall1_hero.webp',
            '/images/masterclasses/hall1_alt1.webp',
            '/images/masterclasses/hall1_alt2.webp',
            '/images/masterclasses/hall1_alt3.webp'
        ],
    ...
    { 
        ...
        imageUrls: [
            '/images/masterclasses/hall2_hero.webp',
            '/images/masterclasses/hall2_alt1.webp',
            '/images/masterclasses/hall2_alt2.webp'
        ],
