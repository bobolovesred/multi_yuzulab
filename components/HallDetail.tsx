...
const FAKE_HALL_DATA_SOURCE: HallRentalInfo[] = [
    { 
        ...
        imageUrls: [
            '/images/masterclasses/hall1_hero.png',
            '/images/masterclasses/hall1_alt1.png',
            '/images/masterclasses/hall1_alt2.png',
            '/images/masterclasses/hall1_alt3.png'
        ],
    ...
    { 
        ...
        imageUrls: [
            '/images/masterclasses/hall2_hero.png',
            '/images/masterclasses/hall2_alt1.png',
            '/images/masterclasses/hall2_alt2.png'
        ],
