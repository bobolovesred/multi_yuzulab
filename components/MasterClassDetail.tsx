...
const FAKE_MASTERCLASS_DATA_SOURCE: MasterClassEvent[] = [
  { 
    ...
    price: 3000, 
    image: '/images/masterclasses/mc_studio_card.webp', 
    imageUrls: ['/images/masterclasses/mc1_hero.webp', '/images/masterclasses/mc1_gallery1.webp', '/images/masterclasses/mc1_gallery2.webp'],
    ...
    instructorImage: '/images/masterclasses/instructor_alex.webp',
    program: [
  ...
  { 
    ...
    price: 2500, 
    image: '/images/masterclasses/mc_floristry_card.webp', 
    imageUrls: ['/images/masterclasses/mc2_hero.webp', '/images/masterclasses/mc2_gallery1.webp'],
    ...
    instructorImage: '/images/masterclasses/instructor_elena.webp',
    program: [
   ...
   { 
    ...
    price: 2000, 
    image: '/images/masterclasses/mc_photobook_card.webp', 
    imageUrls: ['/images/masterclasses/mc3_hero.webp', '/images/masterclasses/mc3_gallery1.webp', '/images/masterclasses/mc3_gallery2.webp'],
    ...
    instructorImage: '/images/masterclasses/instructor_ivan.webp',
    program: [
